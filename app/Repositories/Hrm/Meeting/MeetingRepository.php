        ...
        return [
            'data' => $files->map(function ($data) {
                ...
                if (hasPermission('meeting_view')) {
                    $action_button .= '<a href="' . route('meeting.view', [$data->id]) . '" class="dropdown-item"> ' . _trans('common.View') . '</a>';
                }
                if (hasPermission('meeting_edit')) {
                    $action_button .= '<a href="' . route('meeting.edit', [$data->id]) . '" class="dropdown-item"> ' . _trans('common.Edit') . '</a>';
                }
    ...
    function createAttributes()
    {
        return [
            ...
            'date' => [
                ...
                'required' => true,
                'id'    => 'date',
                'class' => 'form-control ot-form-control ot-input s_date',
                'col'   => 'col-md-12 form-group mb-3',
            ...
            'start_time' => [
                ...
                'required' => true,
                'id'    => 'start_time',
                'class' => 'form-control ot-form-control ot-input s_time',
            ...
            'description' => [
                ...
                'row' => 5,
                'id'    => 'description',
                'class' => 'form-control ot-input mt-0',
                'col'   => 'col-md-12 form-group  mb-3',
            ...
            'attachment' => [
                ...
                'class' => 'form-control ot-input ot-form-control mt-0',
                'col'   => 'col-md-12 form-group  mb-3',
    ...
    function editAttributes($updateModel)
    {
        ...
        return [
            ...
            'attachment' => [
                ...
                'required' => false,
                'id'    => 'attachment',
                'class' => 'form-control ot-form-control ot-input mt-0',
                'col'   => 'col-md-12 form-group  mb-3',
                'label' => _trans('common.Attachment')
            ],
            'status_id' => [
            ...
            if (@$request->user_id) {
                foreach ($request->user_id as $participant) {
                    ...
                    $details = [
                        ...
                        'body' => "You're assigned to a new meeting. Please check it.",
                        'actionText' => 'View',
                        'actionURL' => [
                            'app' => 'meeting',
                            'web' => '',
                    ...
                    $this->sendChannelFirebaseNotification('user'.$participant, 'new_meeting', null, 'new_meeting', $details['title'], $details['body'],null);
                    $this->sendCustomNotification($participant, $details, $notification_for);
