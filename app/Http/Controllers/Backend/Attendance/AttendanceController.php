...
class AttendanceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data['checkbox'] = true;
        $data['title'] = _trans('attendance.Daftar Absensi');
        ...
        return view('backend.attendance.attendance.index', compact('data', 'provinsi'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($store->original['result']) {
                ...
                Toastr::success(_trans('attendance.Absensi berhasil dilakukan'), 'Success');
            ...
            Toastr::error(_trans('response.Ada kesalahan , silakan coba lagi'), 'Error');
            return redirect()->back();
        }
    }
