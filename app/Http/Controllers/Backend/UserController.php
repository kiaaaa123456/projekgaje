...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $data['title'] = _trans('common.Daftar Fasilitator');
            $data['designations'] = [];
            ...
            $peran  = DB::select(DB::raw("SELECT * FROM departments ORDER BY id ASC"));
            ...
            $kecamatan  = DB::select(DB::raw("SELECT * FROM wilayah_kecamatan ORDER BY nmkec ASC"));
            $desa  = DB::select(DB::raw("SELECT * FROM wilayah_desa ORDER BY nmdesa ASC"));


            return view('backend.user.index', compact('data', 'peran', 'provinsi', 'kabupaten', 'kecamatan', 'desa'));
