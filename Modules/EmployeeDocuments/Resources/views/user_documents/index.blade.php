    ...
    <div class="table-content table-basic">
        <div class="card">
            <div class="card-body">
                    ...
                    <div class="align-self-center">
                        ...
                        <div class="align-self-center">
                            @if (hasPermission('conference_create'))
                                <a href="{{ route('user-documents.create') }}" role="button" class="btn-add"
                ...
                <div class="table-responsive _ajaxData">
...
@endsection
@section('script')
    <script src="{{ asset('modules/employeedocuments/js/app.js') }}"></script>
@endsection
