                    ...
                    <div class="align-self-center">
                        <div class="d-flex flex-wrap gap-2  flex-lg-row justify-content-center align-content-center">
                            ...
                            <div class="align-self-center">
                                <label>
                                    ...
                                    <select class="form-select d-inline-block" id="entries"
                                        onchange="get_service_institution_datatable()">
                            ...
                            <div class="align-self-center d-flex flex-wrap gap-2">
                                ...
                                @if (hasPermission('service_institution_create'))
                                    <div class="align-self-center">
                                        <a href="javascript:;" role="button" class="btn-add" data-bs-toggle="tooltip"
                                            onclick="mainModalOpen(`{{ route('institutions.create_modal') }}`)"
                            ...
                            <div class="align-self-center">
                                <div class="search-box d-flex">
                                    <input class="form-control" placeholder="{{ _trans('common.Search') }}" name="search"
                                        onkeyup="get_service_institution_datatable()" autocomplete="off">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item" href="#"
                                                onclick="tableAction('active', `{{ route('institutions.statusUpdate') }}`)"><span
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="#" aria-current="true"
                                                onclick="tableAction('inactive',`{{ route('institutions.statusUpdate') }}`)">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="#"
                                                onclick="tableAction('delete', `{{ route('institutions.delete_data') }}`)">
...
@section('script')
    ...
    <script>
        function get_service_institution_datatable(...values) {
            var tableUrl = $('meta[name="base-url"]').attr("content");
            let data = [];
            let url = tableUrl + "/services/institutions";
            console.log(url);
            data["url"] = url;
            ...
            data["table_id"] = "service_institution_table";
            table(data);
        }
        $(".service_institution_table").length > 0 ? get_service_institution_datatable() : "";
    </script>
@endsection
