                    ...
                    <div class="align-self-center">
                        <div class="d-flex flex-wrap gap-2  flex-lg-row justify-content-center align-content-center">
                            ...
                            <div class="align-self-center">
                                <label>
                                    ...
                                    <select class="form-select d-inline-block" id="entries"
                                        onchange="get_service_machine_datatable()">
                            ...
                            <div class="align-self-center d-flex flex-wrap gap-2">
                                ...
                                @if (hasPermission('service_machine_create'))
                                    <div class="align-self-center">
                                        <a href="javascript:;" role="button" class="btn-add" data-bs-toggle="tooltip"
                                            onclick="mainModalOpen(`{{ route('machines.create_modal') }}`)"
                            ...
                            <div class="align-self-center">
                                <div class="search-box d-flex">
                                    <input class="form-control" placeholder="{{ _trans('common.Search') }}" name="search"
                                        onkeyup="get_service_machine_datatable()" autocomplete="off">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item" href="#"
                                                onclick="tableAction('active', `{{ route('machines.statusUpdate') }}`)"><span
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="#" aria-current="true"
                                                onclick="tableAction('inactive',`{{ route('machines.statusUpdate') }}`)">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="#"
                                                onclick="tableAction('delete', `{{ route('machines.delete_data') }}`)">
...
@section('script')
    ...
    <script>
        function get_service_machine_datatable(...values) {
            var tableUrl = $('meta[name="base-url"]').attr("content");
            let data = [];
            let url = tableUrl + "/services/machines";
            console.log(url);
            data["url"] = url;
            ...
            data["column"] = ["id", "machine_name", "brand_id", "model_id", "origin", "status", "action"];
            data["table_id"] = "service_machine_table";
            table(data);
        }
        $(".service_machine_table").length > 0 ? get_service_machine_datatable() : "";
    </script>
@endsection
