                        ...
                        <div class="d-flex flex-wrap gap-2  flex-lg-row justify-content-center align-content-center">
                            ...
                            <div class="align-self-center">
                                <label>
                                    ...
                                    <select class="form-select d-inline-block" id="entries"
                                        onchange="get_service_package_datatable()">
                            ...
                            <div class="align-self-center d-flex flex-wrap gap-2">
                                ...
                                @if (hasPermission('service_package_create'))
                                    <div class="align-self-center">
                                        <a href="{{ route('packageDetails.create') }}" role="button" class="btn-add" data-bs-toggle="tooltip"
                            ...
                            <div class="align-self-center">
                                <div class="search-box d-flex">
                                    <input class="form-control" placeholder="{{ _trans('common.Search') }}" name="search"
                                        onkeyup="get_service_package_datatable()" autocomplete="off">
...
@section('script')
    ...
    <script>
        function get_service_package_datatable(...values) {
            var tableUrl = $('meta[name="base-url"]').attr("content");
            let data = [];
            let url = tableUrl + "/services/packages";
            console.log(url);
            data["url"] = url;
            ...
            data["column"] = ["id", "package_no","name","contract_date", "status", "action"
            ];
            data["table_id"] = "service_package_table";
            table(data);
        }
        $(".service_package_table").length > 0 ? get_service_package_datatable() : "";
