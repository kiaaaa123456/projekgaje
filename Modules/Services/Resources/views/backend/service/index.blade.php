                            ...
                            <div class="align-self-center">
                                <label>
                                    ...
                                    <select class="form-select d-inline-block" id="entries"
                                        onchange="get_service_module_service_datatable()">
                            ...
                            <div class="align-self-center">
                                <div class="search-box d-flex">
                                    <input class="form-control" placeholder="{{ _trans('common.Search') }}" name="search"
                                        onkeyup="get_service_module_service_datatable()" autocomplete="off">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            <a class="dropdown-item" href="#"
                                                onclick="tableAction('active', `{{ route('services.statusUpdate') }}`)"><span
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="#" aria-current="true"
                                                onclick="tableAction('inactive',`{{ route('services.statusUpdate') }}`)">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="#"
                                                onclick="tableAction('delete', `{{ route('services.delete_data') }}`)">
...
@section('script')
    ...
    <script>
        function get_service_module_service_datatable(...values) {
            var tableUrl = $('meta[name="base-url"]').attr("content");
            let data = [];
            let url = tableUrl + "/services/module-services";
            console.log(url);
            data["url"] = url;
            ...
            data["column"] = ["id", "institution_id", "package_id","date", "status",
                "action"
            ];
            data["table_id"] = "service_module_service_table";
            table(data);
        }
        $(".service_module_service_table").length > 0 ? get_service_module_service_datatable() : "";
    </script>
@endsection
