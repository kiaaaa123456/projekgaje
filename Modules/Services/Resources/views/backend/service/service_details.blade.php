...
@section('script')
    ...
    <script>
        function get_service_module_service_details_datatable(...values) {
            ...
            let data = [];
            let url = tableUrl + "/services/module-services/details";
            console.log(url);
            data["url"] = url;
            ...
            data["column"] = ["id", "module_service_id", "installation_date", "contract_person_id", "machine_id", "contract_date", "serial_number", "status",
                "action"
            ];
