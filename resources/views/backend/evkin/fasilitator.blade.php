    ...
    <div class="sidebar-menu">
        ...
        <main class="main-content ph-32 pt-100 pb-20" id="__index_ltn">
            <div class="page-content">
                    ...
                    <div class="breadcrumb-warning d-flex justify-content-between ot-card"><div><h3>Fasilitator Evkin</h3></div><nav aria-label="breadcrumb "><ol class="breadcrumb ot-breadcrumb ot-breadcrumb-basic"><li class="breadcrumb-item "><a href="https://www.sistemweb.my.id/dashboard">Dashboard</a></li><li class="breadcrumb-item active">Evkin</li></ol></nav></div>
...
<option value="1000">1000</option>                                    </select>
    ...
    <thead class="thead">
        <tr>
            ...
            <th class="sorting_desc">Tingkat</th>
            <th class="sorting_desc">Wilayah</th>
            <th class="sorting_desc">Nilai</th>
            <th class="sorting_desc">Aksi</th>
        </tr>
        <tr>
            <th class="sorting_desc">1</th>
            <th class="sorting_desc">Bastiar Pramana</th>
            <th class="sorting_desc">Kader Desa</th>
            <th class="sorting_desc">Desa Waropen Distrik Merauke</th>
            <th class="sorting_desc"><button class="btn btn-sm btn-warning">Belum dinilai</button</th>
            <th class="sorting_desc"><a href="{!!url('hrm/evkin/penilaian')!!}"><i class="fa fa-edit"></i></a></th>
        </tr>
        <tr>
            <th class="sorting_desc">2</th>
            <th class="sorting_desc">Mustofa Zaenal</th>
            <th class="sorting_desc">Kader Desa</th>
            <th class="sorting_desc">Desa Waropen Distrik Merauke</th>
            <th class="sorting_desc"><button class="btn btn-sm btn-warning">Belum dinilai</button></th>
            <th class="sorting_desc"><a href="{!!url('hrm/evkin/penilaian')!!}"><i class="fa fa-edit"></i></a></th>
        ...
        <tr>
            ...
            <th class="sorting_desc">Nasuha</th>
            <th class="sorting_desc">Kader Desa</th>
            <th class="sorting_desc">Desa Waropen Distrik Merauke</th>
            <th class="sorting_desc">80</th>
            <th class="sorting_desc"><button class="btn btn-sm btn-success">Sudah dinilai</button></th>
        </tr>
        <tr>
            <th class="sorting_desc">4</th>
            <th class="sorting_desc">Iwan Setiawan</th>
            <th class="sorting_desc">Kader Desa</th>
            <th class="sorting_desc">Desa Waropen Distrik Merauke</th>
