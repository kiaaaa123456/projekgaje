<div class="profile-body p-40 pl-40 pr-40 pt-10">
    ...
    <div class="profile-body-form">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group mt-20">
                    <label class="mb-10">{{ _trans('profile.Passport Number') }}</label>
                    <input type="text" class="form-control ot-form-control ot-input" placeholder="{{ _trans('profile.Enter Passport Number') }}" name="passport_number" value="{{ @$data['show']->original['data']['passport_number']??old('passport_number') }}">
            ...
            <div class="col-lg-4">
                <div class="form-group mt-20">
                    <label class="mb-10">{{ _trans('profile.Passport Expire Date') }} </label>
                    <input type="text" class="form-control ot-form-control ot-input expire-date"
                        name="passport_expire_date" placeholder="{{ _trans('profile.Passport Expire Date') }}"  value="{{ @$data['show']->original['data']['passport_expire_date'] }}" >
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group mt-20">
                    <label class="mb-10">{{ _trans('profile.EID Number') }}
                    </label>
                    <input type="text" class="form-control ot-form-control ot-input"
                        placeholder="{{ _trans('profile.Enter EID Number') }}" name="eid_number"
                        value="{{ @$data['show']->original['data']['eid_number'] }}">
            ...
            <div class="col-lg-4">
                <div class="form-group mt-20">
                    <label class="mb-10">{{ _trans('profile.EID Expire Date') }} </label>
                    <input type="text" class="form-control ot-form-control ot-input expire-date" name="eid_expire_date" placeholder="{{ _trans('profile.EID Date') }}"  value="{{ @$data['show']->original['data']['eid_expire_date'] }}">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group mt-20">
                    ...
                    <input type="text" class="form-control ot-form-control ot-input"
                        ...
                        value="{{ @$data['show']->original['data']['visa_number'] }}">
            ...
            <div class="col-lg-4">
                <div class="form-group mt-20">
                    ...
                    <input type="text" class="form-control ot-form-control ot-input expire-date"
                        name="visa_expire_date" placeholder="{{ _trans('profile.Visa Expire Date') }}" value="{{ @$data['show']->original['data']['visa_expire_date'] }}">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group mt-20">
                    ...
                    <input type="text" class="form-control ot-form-control ot-input"
                        ...
                        value="{{ @$data['show']->original['data']['insurance_number'] }}">
            ...
            <div class="col-lg-4">
                <div class="form-group mt-20">
                    ...
                    <input type="text" class="form-control ot-form-control ot-input expire-date"  name="insurance_expire_date" placeholder="{{ _trans('profile.Insurance Expire Date') }}" value="{{ @$data['show']->original['data']['insurance_expire_date'] }}">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="form-group mt-20">
                    ...
                    <input type="text" class="form-control ot-form-control ot-input"  placeholder="{{ _trans('profile.Enter Labour Card Number') }}" name="labour_card_number"  value="{{ @$data['show']->original['data']['labour_card_number'] }}">
            ...
            <div class="col-lg-4">
                <div class="form-group mt-20">
                    ...
                    <input type="text" class="form-control ot-form-control ot-input expire-date"  name="labour_card_expire_date" placeholder="{{ _trans('profile.Labour Card Expire Date') }}" value="{{ @$data['show']->original['data']['labour_card_expire_date'] }}">
