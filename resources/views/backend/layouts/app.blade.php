...
<head>
    ...
    <title> E-LAPKIN | @yield('title')</title>
    <meta name="keywords" content="">
    <meta name="description" content=" ">
    <link rel="shortcut icon" href="{!!url('assets/logotekad.ico')!!}">
    @if (env('APP_ENV') == 'production')
    <meta http-equiv="Content-Security-Policy" content="upgrade-insecure-requests">
    @endif
    <meta name="base-url" id="base-url" content="https://tekad.kemendesa.go.id/e-lapkin">
    {{-- Header start --}}
...
<body class="default-theme" style="background: #fff;">
    ...
    <input type="hidden" id="get_custom_user_url" value="https://tekad.kemendesa.go.id/e-lapkin/dashboard/user/get-users">
