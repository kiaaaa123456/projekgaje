                            ...
                            <div class="align-self-center">
                                <label>
                                    ...
                                    <select class="form-select d-inline-block" id="entries"
                                        onchange="salaryAdvanceDatatable()">
                            ...
                            <div class="align-self-center d-flex flex-wrap gap-2">
                                ...
                                <div class="align-self-center">
                                    @if (hasPermission('advance_salaries_create'))
                                        <a href="{{ route('hrm.payroll_advance_salary.create') }}" role="button"
                                ...
                                <div class="align-self-center">
                                    ...
                                    <input type="hidden" id="daterange-input" onchange="salaryAdvanceDatatable()">
                                </div>
                                <!-- Designation -->
                                <div class="align-self-center">
                                ...
                                <div class="align-self-center">
                                    <div class="dropdown dropdown-designation" data-bs-toggle="tooltip"
                                        data-bs-placement="right" data-bs-title="{{ _trans('common.Return Status') }}">
                                        <button type="button" class="btn-designation" data-bs-toggle="dropdown"
                                            aria-expanded="false" data-bs-auto-close="false">
                                            <span class="icon"><i class="fa fa-reply" aria-hidden="true"></i></span>
                                            <span class="d-none d-xl-inline">{{ _trans('common.Return Status') }}</span>
                                        </button>
                                        ...
                                        <div class="dropdown-menu align-self-center ">
                                            <select name="return_status" id="return_status"
                                                ...
                                                <option value="0" selected disabled>
                                                    {{ _trans('common.Return Status') }}</option>
                                ...
                                <div class="align-self-center">
                                    <div class="dropdown dropdown-designation" data-bs-toggle="tooltip"
                                        ...
                                        <div class="dropdown-menu align-self-center ">
                                            <select name="status" id="status" onchange="salaryAdvanceDatatable()"
                                                class="form-control select2 custom-select-width">
                                                <option value="0" selected disabled>{{ _trans('common.Status') }}
                                                </option>
                                ...
                                <div class="align-self-center">
                                    <div class="dropdown dropdown-designation" data-bs-toggle="tooltip"
                                        data-bs-placement="right" data-bs-title="{{ _trans('common.Payment Status') }}">
                                        <button type="button" class="btn-designation" data-bs-toggle="dropdown"
                                            aria-expanded="false" data-bs-auto-close="false">
                                            <span class="icon"><i class="fa fa-credit-card-alt"
                                                    aria-hidden="true"></i></span>
                                            <span class="d-none d-xl-inline">{{ _trans('common.Payment Status') }}</span>
                                        </button>

                                        <div class="dropdown-menu align-self-center ">
                                            <select name="payment" id="payment" onchange="salaryAdvanceDatatable()"
                                                class="form-control select2 custom-select-width">
                                                <option value="0" selected disabled>
                                                    {{ _trans('common.Payment Status') }} </option>
                                ...
                                <div class="align-self-center">
                                    <div class="search-box d-flex">
                                        <input class="form-control" placeholder="{{ _trans('common.Search') }}"
                                            name="search" onkeyup="salaryAdvanceDatatable()" autocomplete="off">
