                    ...
                    <div class="col-md-12">
                        <form action="{{ $data['url'] }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="number" class="form-control ot-input" min="1" name="amount"
                                    id="Amount" autocomplete="off" value="{{ $data['advance']->amount }}" readonly />
                            </div>
                            <div class="form-group mb-3">
                                <label class="form-label">{{ _trans('common.Category') }}</label>
                                <select name="category" class="form-select ot-input modal_select2">
                            ...
                            <div class="form-group mb-3">
                                <label class="form-label">{{ _trans('common.Note') }} <span
                                        class="text-danger">*</span></label>
                                <textarea type="text" name="description" rows="5" class="form-control ot-input mt-0"
                            ...
                            <div class="form-group text-right d-flex justify-content-end">
                                <button type="submit"
                                    class="btn btn-gradian pull-right"><b>{{ _trans('common.Submit') }}</b></button>
                            </div>
                        </form>
