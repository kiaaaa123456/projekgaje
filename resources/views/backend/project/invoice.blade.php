...
<head>
    ...
    <link rel="stylesheet" href="{{ global_asset('backend/css/invoice.css') }}">
</head>
    ...
    <div>
        ...
        <div style="background: #eceff4;padding: 1rem;">
            <table>
                <tr>
                    <td>
                        <img class="full-logo white_logo"
                            src="{{ uploaded_asset(@base_settings('company_logo_backend')) }}" alt="" />
                    </td>
                    <td style="font-size: 1.5rem;" class="text-right strong">{{ _trans('common.INVOICE') }} </td>
                </tr>
            </table>
            <table>
                <tr>
        ...
        <div style="padding: 1rem;padding-bottom: 0">
            <table>
                ...
                <tr>
                    <td class="gry-color small">{{ _trans('common.Email') }}: {{ $data['project']->client->email }}
                    </td>
                </tr>
                <tr>
                    <td class="gry-color small">{{ _trans('common.Phone') }}: {{ $data['project']->client->phone }}
                    </td>
                </tr>
            </table>
        </div>
