                            ...
                            <div class="align-self-center d-flex  flex-wrap gap-2">
                                ...
                                <div class="align-self-center">
                                    <div class="dropdown dropdown-designation" data-bs-toggle="tooltip"
                                        data-bs-placement="right" data-bs-title="{{ _trans('common.Purpose') }}">
                                        ...
                                        <div class="dropdown-menu align-self-center ">
                                            <select name="category_id" id="category_id"
                                                class="form-control pl-2 select2 w-100" onchange="expensePaymentTable()">
                                ...
                                <div class="align-self-center">
                                    <div class="search-box d-flex">
                                        <input class="form-control" placeholder="{{ _trans('common.Search') }}"
                                            name="search" onkeyup="expensePaymentTable()" autocomplete="off">
