@if (hasPermission('travel_menu'))
    <li class="sidebar-menu-item {{ set_menu([route('travel.index')]) }}">
        <a href="javascript:void(0)" class="parent-item-content has-arrow {{ menu_active_by_route(['travel_type.index','travel.index','travel.create','travel.edit','travel.view']) }}">
        ...
        <ul class="child-menu-list {{ set_active(['admin/travel*']) }}">
            ...
            @if (hasPermission('travel_menu'))
                <li class="sidebar-menu-item {{ menu_active_by_route(['travel.index','travel.create','travel.edit','travel.view']) }}">
