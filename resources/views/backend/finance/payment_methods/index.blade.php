...
@section('content')
    {!! breadcrumb([
        ...
        url()->current() => _trans('common.Accounts'),
                            ...
                            <div class="align-self-center">
                                <label>
                                    ...
                                    <select class="form-select d-inline-block" id="entries"
                                        onchange="paymentMethodDatatable()">
                                    ...
                                    @if (hasPermission('payment_method_create'))
                                        <div class="align-self-center">
                                            <a href="javascript:;" role="button" class="btn-add" data-bs-toggle="tooltip"
                                                onclick="mainModalOpen(`{{ @$data['create'] }}`)" data-bs-placement="right"
                            ...
                            <div class="align-self-center">
                                <div class="search-box d-flex">
                                    <input class="form-control" placeholder="{{ _trans('common.Search') }}" name="search"
                                        onkeyup="paymentMethodDatatable()" autocomplete="off">
