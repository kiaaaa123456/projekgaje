                    ...
                    <div class="align-self-center">
                        <div class="d-flex flex-wrap gap-2  flex-lg-row justify-content-center align-content-center">
                            ...
                            <div class="align-self-center">
                                <label>
                                    ...
                                    <select class="form-select d-inline-block" id="entries"
                                        onchange="performanceSettingsTable('competence_type_table_url')">
                            ...
                            <div class="align-self-center d-flex flex-wrap gap-2">
                                ...
                                @if (hasPermission('performance_competence_type_create'))
                                    <div class="align-self-center">
                                        <a href="javascript:;"
                                            onclick="viewModal(`{{ route('performance.competence.type.create') }}`)"
                            ...
                            <div class="align-self-center">
                                <div class="search-box d-flex">
                                    <input class="form-control" placeholder="{{ _trans('common.Search') }}" name="search"
                                        onkeyup="performanceSettingsTable('competence_type_table_url')" autocomplete="off">
