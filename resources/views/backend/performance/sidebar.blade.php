...
@if (hasPermission('performance_menu'))
    <li class="sidebar-menu-item">
        <a href="javascript:void(0)" class="parent-item-content has-arrow {{ menu_active_by_route(['performance.indicator.index','performance.appraisal.index','performance.goal.index','performance.competence.type.index','performance.goal_type.index','performance.competence.index']) }}">
        ...
        <ul class="child-menu-list {{ set_active(['admin/performance*']) }}">
            ...
            @if (hasPermission('performance_settings'))
                <li class="sidebar-menu-item {{ set_menu([route('performance.competence.type.index')]) }} ">
                    <a href="javascript:void(0)" class="parent-item-content has-arrow nav-item {{ menu_active_by_route(['performance.competence.type.index','performance.competence.index','performance.goal_type.index']) }}">
                        <span class="">
                    ...
                    <ul
                        class="child-menu-list {{ set_active(['admin/performance/settings*']) }} pl-2">
                        ...
                        @if (hasPermission('performance_goal_type_menu'))
