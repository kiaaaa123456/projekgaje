    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content data">
            <div class="modal-header mb-3" style="background-color:#dbfbd7">
                <h5 class="modal-title" style="color:black">Masuk Kerja </h5>
            ...
            <div class="modal-body">
                <div class="row pb-4 text-align-center">
                    <div class="col-md-12">
                        ...
                        <!-- <input type="text" id="form_url" value="{{ @$data['url'] }}"> -->
                        <input type="hidden" id="form_url" value="https://tekad.kemendesa.go.id/e-lapkin/dashboard/ajax-checkin">
                    </div>
                </div>
            </div>
        </div>
