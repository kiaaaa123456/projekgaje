                        ...
                        <div class="col-md-12">
                            <div class="col-md-7 mx-auto">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" name="days" class="form-control ot-form-control ot-input"
                            ...
                            <div class="col-md-7 mx-auto">
                                <div class="form-group mb-3">
                                    <label for="name"
                                        class="form-label">{{ _trans('leave.Jenis Tidak Masuk') }} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-7 mx-auto">
                                <div class=" d-flex justify-content-end">
                                    @if (hasPermission('leave_assign_create'))
                                        <button type="submit"
                                            class="btn btn-gradian">{{ _trans('common.Save') }}
                                        </button>
                                    @endif
                                </div>
                            </div>
