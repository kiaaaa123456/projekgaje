                                    ...
                                    <div class="col-md-4">
                                        <div class="col-md-12 mt-3">
                                            <div class="form-group">
                                                <label for="name" class="form-label">{{ _trans('common.Nama') }} <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="name" class="form-label">{{ _trans('common.No Telepon') }} <span class="text-danger">*</span></label>
                                                <input type="number"
                                                       name="phone"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="joining_date" class="form-label">{{ _trans('common.Tanggal Bergabung') }} <span class="text-danger">*</span></label>
                                                <input type="date"
                                                       name="joining_date"
                                                       autocomplete="off"
