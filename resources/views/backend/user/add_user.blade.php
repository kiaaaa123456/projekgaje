                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" name="basic_salary" placeholder="{{ _trans('common.Salary') }}"
                                    autocomplete="off" class="form-control ot-form-control ot-input"
                                    value="{{ old('basic_salary') }}"  step=0.01 required>
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                <label class="form-label" for="name"
                                    class="form-label">{{ _trans('common.Confirm Password') }} <span
                                        class="text-danger">*</span></label>
                    ...
                    <div class="col-md-6">
                        <div class="role-permisssion-control">
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    <label class="form-label" for="name"
                                        class="form-label">{{ _trans('common.Role') }} <span
                                            class="text-danger">*</span></label> [<a href="javascript:;" role="button"  onclick="mainModalOpen(`{{ route('role.create_modal') }}`)"> <span><i class="fa-solid fa-plus"></i> </span>
                                                                        ...
                                                                        <div class="input-check-radio">
                                                                            <div class="form-check">
                                                                                ...
                                                                                <label class="form-check-label ml-6"
                                                                                    for="#"><span>{{ ucfirst(str_replace('_', ' ', __($permission->attribute))) }}</span>
                                                                                </label>
                                                                            </div>
                                                                        </div>
                                                                    </button>
