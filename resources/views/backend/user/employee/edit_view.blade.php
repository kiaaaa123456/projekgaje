            ...
            <form method="POST" action="{{ route('user.update', $data['show']->id) }}" enctype="multipart/form-data">
                ...
                <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                ...
                                <select name="country" class="form-control ot-form-control ot-input select2"
                                    ...
                                    <option value="{{ $country->id }}" {{ $data['show']->country_id == $country->id ? 'selected' : '' }}>
                                        {{ $country->name }}
                                    </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="col-md-12">
                            <div class="form-group mb-3">
                                <label for="designation_id" class="form-label">{{ _trans('user.Manager') }}</label>
                                <select name="manager_id" class="form-select select2" required>
                                    <option value="" disabled>{{ _trans('common.Choose One') }}
                                    </option>
                                    @foreach($data['managers'] as $manager)
                                        <option value="{{ $manager->id }}" {{ $data['show']->manager_id === $manager->id ? 'selected' :'' }}>{{ $manager->name }}</option>
                                    @endforeach
                                </select>
                                ...
                                <select name="status" id="status" class="form-select ot-input select2" required>
                                    @foreach ($data['statuses'] as $key => $status)
                                        <option value="{{ $status->id }}"
                                            {{ @$data['show']->status_id == $status->id ? 'selected' : '' }}>
                                            {{ $status->name }}
                                        </option>
                                    @endforeach
                                </select>
