   ...
   @if (Session::has('toastr'))
    ...
    <script>
        ...
        // $( function() {
        //     $('#tanggal').datepicker({ dateFormat: 'dd-mm-yy',  changeMonth: true, changeYear: true, minDate: '0' }).val();
        // } );

        $( function() {
            $('#tanggal').datepicker({ dateFormat: 'dd-mm-yy',  changeMonth: true, changeYear: true }).val();
        } );

        $( function() {
            $('#tanggal_1').datepicker({ dateFormat: 'dd-mm-yy',  changeMonth: true, changeYear: true }).val();
        } );

        // $(function() {
        //     $(".daterange-table-filter").daterangepicker({
        //         locale: {
        //             format: 'DD-MMM-YYYY'
        //         }
        //     });
