...
<link rel="stylesheet" href="https://unpkg.com/leaflet/dist/leaflet.css"/>
    ...
    <div><h3>Tambah Aktivitas Harian</h3></div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <label class="form-label" for="name">Rencana<span
                                                            class="text-danger">*</span></label>
                                                    <textarea name="title" class="form-control mt-0 ot-input" placeholder="{{ _trans('common.Masukkan Rencana Kegiatan') }}" rows="6" required oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                    <label class="form-label">Realisasi<span
                                                            class="text-danger">*</span></label>
                                                    <textarea name="description" class="form-control mt-0 ot-input" placeholder="{{ _trans('common.Masukkan Realisasi Kegiatan') }}" rows="6" required oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control ot-form-control ot-input"
                                                        name="appoinment_end_at" placeholder="{{ _trans('common.Jam Berakhir') }}" value="{{ old('appoinment_end_at') }}"  oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="file" class="form-control ot-form-control ot-input"
                                                        name="file" id="file" placeholder="{{ _trans('common.Lampiran Kegiatan') }}" value="{{ old('file') }}" required oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')" onchange="return validationFile()">
                                                    @if ($errors->has('file'))
...
<script type="text/javascript">
    ...
    var map = L.map('map').setView([51.505, -0.09], 13); // Set initial zoom to 13
