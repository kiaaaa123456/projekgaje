...
@section('content')
    ...
    <div><h3>{{$fas}} [{{Auth::user()->name}}]</h3><i class="fa fa-map"></i> {{$wilayah}}</div>
    ...
    <div class="d-flex justify-content-between flex-wrap dashboard-heading  align-items-center pb-24 gap-3">
        ...
        <div class="dropdown card-button">
            ...
            <ul class="dropdown-menu c-dropdown-menu" aria-labelledby="revenueBtn">
                <li>
                    <a class="dropdown-item profile_option" href="{!!url('tidak-masuk-saya')!!}"> Tidak Masuk Saya</a>
                </li>
                <li>
                    <a class="dropdown-item profile_option" href="{!!url('tidak-masuk-tim')!!}">
                        {{$fas}}
                    </a>
                </li>
            </ul>
...
<script type="text/javascript">
    ...
    function loadData(page, limit, date){
        ...
        $.ajax({
        url: "tidak-masuk-tim/"+page+'/'+limit+'/'+date,
        type: 'get',
        dataType: 'json',
