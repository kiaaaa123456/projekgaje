...
@section('content')
    ...
    <div><h3>Tidak Masuk Saya [{{Auth::user()->name}}]</h3><i class="fa fa-map"></i> {{$wilayah}}</div>
    <nav aria-label="breadcrumb ">
        <ol class="breadcrumb ot-breadcrumb ot-breadcrumb-basic">
            <li class="breadcrumb-item"><a href="{!!url('dashboard')!!}">Dashboard</a></li>
            <li class="breadcrumb-item active">Tidak Masuk Saya</li>
...
<div class="d-flex justify-content-between flex-wrap dashboard-heading  align-items-center pb-24 gap-3">
    ...
    <div class="dropdown card-button">
        <button class="btn btn-secondary ot-dropdown-btn dropdown-toggle" type="button" id="revenueBtn" data-bs-toggle="dropdown" aria-expanded="false" style="background:#385834">
            <span id="__selected_dashboard">Tidak Masuk Kerja Saya</span>
            <i class="las la-angle-down"></i>
        </button>
        <ul class="dropdown-menu c-dropdown-menu" aria-labelledby="revenueBtn">
            <li>
                <a class="dropdown-item profile_option" href="{!!url('tidak-masuk-saya')!!}"> Tidak Masuk Kerja Saya</a>
            </li>
                ...
                <div class="align-self-center">
                    <div class="d-flex flex-wrap gap-2 flex-lg-row justify-content-center align-content-center">
                       ...
                       <!--  <div class="align-self-center d-flex flex-wrap gap-2">
                        ...
                        <div class="align-self-center d-flex flex-wrap gap-2">
                            <a href="{!!url('tambah-tidak-masuk')!!}" class="btn-add"><i class="fa-solid fa-plus"></i> Tambah Data</a>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function loadData(page, limit, date){
        ...
        $.ajax({
        url: "tidak-masuk-saya/"+page+'/'+limit+'/'+date,
        type: 'get',
        dataType: 'json',
                    ...
                    if(len > 0){
                        ...
                        for(var i=0; i<len; i++){
                            ...
                            if (response['data'][i].stt==1) {
                                ...
                                var button = "<a href='edit-tidak-masuk/"+ $.md5(response['data'][i].id_main)+"'><i class='fa fa-edit' style='cursor:pointer' title='Edit Pengajuan'></i></a>";
