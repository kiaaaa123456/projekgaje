    ...
    <div class="d-flex justify-content-between flex-wrap dashboard-heading  align-items-center pb-24 gap-3">
        ...
        <div class="dropdown card-button">
            <button class="btn btn-secondary ot-dropdown-btn dropdown-toggle" type="button" id="revenueBtn" data-bs-toggle="dropdown" aria-expanded="false" style="background:#385834">
                <span id="__selected_dashboard">Evkin Saya </span>
...
<script type="text/javascript">
    ...
    function loadData(page, limit, month, year){
        ...
        $.ajax({
        url: "get-evkin-saya/"+page+"/"+limit+"/"+month+"/"+year,
        type: 'get',
        dataType: 'json',
                    ...
                    if(len > 0){
                        ...
                        for(var i=0; i<len; i++){
                            ...
                            if(response['data'][i].nilai==null) {
                                nilai = '<button class="btn btn-sm btn-warning">Belum dinilai</button>';
                                button = '-';
                            } else {
                                nilai = '<button class="btn btn-sm btn-success">'+response['data'][i].nilai+'</button>';
                                button = '<a href="nilai-fasilitator/'+response["data"][i].id+'/'+id_user+'"><i class="fa fa-eye" style="cursor:pointer" title="Lihat Detail Evkin"></i></a>';
