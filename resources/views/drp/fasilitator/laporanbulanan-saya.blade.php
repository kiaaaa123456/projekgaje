...
@section('title', 'Laporan Bulanan Saya')
@section('content')

	<div class="breadcrumb-warning d-flex justify-content-between ot-card">
    <div><h3>Laporan Bulanan Saya [{{Auth::user()->name}}]</h3><i class="fa fa-map"></i> {{$wilayah}}</div>
    <nav aria-label="breadcrumb ">
        <ol class="breadcrumb ot-breadcrumb ot-breadcrumb-basic">
            <li class="breadcrumb-item"><a href="{!!url('dashboard')!!}">Dashboard</a></li>
            <li class="breadcrumb-item active">Laporan Bulanan Saya</li>
        </ol>
    </nav>
</div>
    ...
    <div class="d-flex justify-content-between flex-wrap dashboard-heading  align-items-center pb-24 gap-3">
        ...
        <div class="dropdown card-button">
            ...
            <ul class="dropdown-menu c-dropdown-menu" aria-labelledby="revenueBtn">
                <li>
                    <a class="dropdown-item profile_option" href="{!!url('laporan-bulanan-saya')!!}"> Laporan Bulanan Saya</a>
                </li>
                @if(Auth::user()->department_id == 7)
                <li>
                    <a class="dropdown-item profile_option" href="{!!url('laporan-bulanan-kader')!!}">Laporan Bulanan Kader</a>
                </li>
                @elseif(Auth::user()->department_id == 6)
                <li>
                    <a class="dropdown-item profile_option" href="{!!url('laporan-bulanan-fasdis')!!}">Laporan Bulanan Fasdis</a>
                </li>
                <li>
                    <a class="dropdown-item profile_option" href="{!!url('laporan-bulanan-kader')!!}">Laporan Bulanan Kader</a>
                </li>
                ...
                <li>
                    <a class="dropdown-item profile_option" href="{!!url('laporan-bulanan-faskab')!!}">Laporan Bulanan Faskab</a>
                </li>
                <li>
                    <a class="dropdown-item profile_option" href="{!!url('laporan-bulanan-fasdis')!!}">Laporan Bulanan Fasdis</a>
                </li>
            ...
            <div class="table-toolbar d-flex flex-wrap gap-2 flex-xl-row justify-content-xxl-between align-content-center pb-3">
                <div class="align-self-center">
                    <div class="d-flex flex-wrap gap-2 flex-lg-row justify-content-center align-content-center">
                            ...
                            <div class="align-self-center">
                                <div class="search-box d-flex">
                                    <select class="form-control act" name="month" id="month">
                                        ...
                                        <option value="{{$bul->month}}">{{$bul->month}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="align-self-center">
                                <div class="search-box d-flex">
                                    <select class="form-control act" name="year" id="year">
                                        ...
                                        <option value="{{$tah->year}}">{{$tah->year}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="align-self-center d-flex flex-wrap gap-2">
                            <a href="{!!url('tambah-laporan-bulanan')!!}" class="btn-add btn-reset"><i class="fa-solid fa-plus"></i> Tambah Data</a>
                        </div>
                ...
                <table class="table table-bordered" id="table-body">
                    <thead class="thead">
                        <tr>
                            ...
                            <th class="sorting_desc">File Lap Bulanan</th>
                            @endif
                            <th class="sorting_desc">File Akt Harian</th>
...
<script type="text/javascript">
    ...
    function loadData(page, limit, month, year){
        ...
        $.ajax({
        url: "laporan-bulanan-saya/"+page+"/"+limit+"/"+month+"/"+year,
        type: 'get',
        dataType: 'json',
                    ...
                    if(len > 0){
                        ...
                        for(var i=0; i<len; i++){
                            ...
                            if (date_now==response['data'][i].date) {
                                var button = "<a href='edit-laporan-bulanan/"+ $.md5(response['data'][i].id_main)+"'><i class='fa fa-edit' style='cursor:pointer' title='Edit Laporan Bulanan'></i></a>";
                            } else {
                                var button = "-";
                            }
                            ...
                            "<td><a href='"+ response['data'][i].file_ttdbasah+"' target='blank'><i class='fa fa-file' style='cursor:pointer'></i></a></td>" +
                            @else
                            "<td><a href='"+ response['data'][i].file+"' target='blank'><i class='fa fa-file' style='cursor:pointer'></i></a></td>" +
                            @endif
                            "<td class='text-wrap'>"+button+"</td>" +
                            "</tr>";
