                    ...
                    <form id="form_data">
                        ...
                        <table class="table table-bordered visit_table" id="table">
                            ...
                            <tr>
                                ...
                                <td class="sorting_desc">Tingkat kehadiran <i class="fa fa-file" id="show-absensi"
                                ...
                                <td class="sorting_desc">
                                    ...
                                    ?>
                                    <input type="text" class="form-control" name="kehadiran" value="{{ $kehadiran }}"
                                        readonly>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="sorting_desc"></td>
                                <td class="sorting_desc">Menyusun laporan harian <i class="fa fa-file" id="show-aktivitas"
                                        style="cursor:pointer"></i></td>
                                <td class="sorting_desc">
                                    <select class="form-control" name="akt_harian" required
                                        ...
                                        <option value="5">5 - Sesuai dengan Tupoksi (100%)</option>
                                        <option value="4">4 - Tidak sesuai dengan Tupoksi (2 kegiatan)</option>
                                        <option value="3">3 - Tidak sesuai dengan Tupoksi (4 kegiatan)</option>
                                        <option value="2">2 - Tidak sesuai dengan Tupoksi (6 kegiatan)</option>
                                        <option value="1">1 - Tidak sesuai dengan Tupoksi (8 kegiatan)</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="sorting_desc"></td>
                                <td class="sorting_desc">Menyusun laporan bulanan <i class="fa fa-file" id="show-bulanan"
                                        style="cursor:pointer"></i></td>
                                <td class="sorting_desc">
                                    <select class="form-control" name="lap_bulanan" required>
                                        <option value="">-Pilih Nilai-</option>
                                        <option value="10">10 - Laporan Sesuai dan Lengkap</option>
                                        <option value="8">8 - Isi Laporan Kurang Sesuai dan Lengkap</option>
                                        <option value="6">6 - Isi Laporan Kurang Sesuai dan Kurang Lengkap</option>
                                        <option value="4">4 - Isi Laporan Kurang Sesuai dan Tidak Lengkap</option>
                                        <option value="2">2 - Isi Laporan Tidak Sesuai dan Tidak Lengkap</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                <td class="sorting_desc">1.2</td>
                                <td class="sorting_desc" colspan="3">PENDAMPINGAN, SUPERVISI, MONITORING DAN EVALUASI
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="sorting_desc">
                                    <select class="form-control" name="pendampingan_tekad" required>
                                        <option value="">-Pilih Nilai-</option>
                                        <option value="10">10 - Pendampingan dilakukan sesuai dengan Kebutuhan kegiatan
                                            Komponen/ Sub Komponen</option>
                                        <option value="6">6 - Pendampingan dilakukan cukup sesuai dengan Kebutuhan
                                            kegiatan Komponen/ Sub Komponen</option>
                                        <option value="2">2 - Pendampingan Tidak sesuai dengan Kebutuhan kegiatan
                                            Komponen/ Sub Komponen</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="sorting_desc">
                                    <select class="form-control" name="supervisi" required>
                                        <option value="">-Pilih Nilai-</option>
                                        <option value="10">10 - Dilakukan Supervisi dan Monev sesuai dengan Target
                                            Group kelompok dan sasaran Program</option>
                                        <option value="6">6 - Dilakukan Supervisi dan Monev namun kurang sesuai Target
                                            Group kelompok dan kurang sesuai dengan sasaran Program</option>
                                        <option value="2">2 - Tidak melakukan Supervisi dan Monev terhadap Target
                                            Group kelompok dan sasaran Program</option>
                                    </select>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="sorting_desc">
                                    <select class="form-control" name="rencana_kerja" required>
                                        <option value="">-Pilih Nilai-</option>
                                        <option value="15">15 - Memiliki Rencana Kerja sesuai dengan Tupoksi </option>
                                        <option value="9">9 - Memiliki Rencana Kerja cukup sesuai dengan Tupoksi
                                        </option>
                                        <option value="3">3 - Tidak memiliki Rencana Kerja sesuai dengan Tupoksi
                                        </option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="sorting_desc">
                                    <select class="form-control" name="output_tupoksi" required>
                                        <option value="">-Pilih Nilai-</option>
                                        <option value="15">15 - Memiliki Uraian Output kegiatan sesuai dengan Tupoksi
                                        </option>
                                        <option value="9">9 - Memiliki Uraian Output kegiatan Cukup sesuai dengan
                                            Tupoksi </option>
                                        <option value="3">3 - Tidak ada uraian Output kegiatan sesuai dengan Tupoksi
                                        </option>
                                    </select>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="sorting_desc">
                                    <select class="form-control" name="pendampingan_masyarakat" required>
                                        <option value="">-Pilih Nilai-</option>
                                        <option value="5">5 - Melakukan kegiatan pendampingan sesuai dengan tupoksi ,
                                            kebutuhan dan jenjang</option>
                                        <option value="3">3 - Melakukan kegiatan pendampingan kurang sesuai mulai dari
                                            tupoksi, kebtuhan dan jenjang </option>
                                        <option value="1">1 - Tidak melakukan kegiatan pendampingan</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="sorting_desc"></td>
                                <td class="sorting_desc">Penanganan dan penyelesaian permasalahan tim kerja (berjenjang)
                                </td>
                                <td class="sorting_desc">
                                    <select class="form-control" name="penanganan" required>
                                        <option value="">-Pilih Nilai-</option>
                                        <option value="5">5 - Melaksanakan penanganan dan penyelesaian permasalahan
                                            tim kerja secara berjenjang</option>
                                        <option value="3">3 - Melaksanan penanganan tetapi tidak menyelesaikan
                                            permasalahan tim kerja secara berjenjang</option>
                                        <option value="1">1 - Tidak melaksanakan penanganan dan penyelesaian
                                            permasalahan tim kerja secara berjenjang tim kerja secara berjenjang</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="sorting_desc">
                                    <select class="form-control" name="loyalitas" required>
                                        <option value="">-Pilih Nilai-</option>
                                        <option value="10">10 - Loyal dan taat terhadap peraturan, hirarki dan tupoksi
                                        </option>
                                        <option value="6">6 - Cukup Loyal dan taat terhadap peraturan, hirarki dan
                                            tupoksi</option>
                                        <option value="2">2 - Tidak Loyal dan taat terhadap peraturan, hirarki dan
                                            tupoksi</option>
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="sorting_desc">
                                    <select class="form-control" name="koordinasi" required>
                                        <option value="">-Pilih Nilai-</option>
                                        <option value="10">10 - Melaksanan koordinasi dan kerjasama sesuai hirarki dan
                                            lini kerja</option>
                                        <option value="6">6 - Melaksanan koordinasi tetapi kurang kerjasama sesuai
                                            hirarki dan lini kerja</option>
                                        <option value="2">2 - Tidak melaksanan koordinasi dan kerjasama sesuai hirarki
                                            dan lini kerja</option>
                                    </select>
                                </td>
                            </tr>
                        </table>
                        <input type="text" hidden id="visit_table_url"
                            value="https://www.sistemweb.my.id/hrm/visit" />
                        <br />
                            ...
                            @else
                                ...
                                @foreach ($aktivitas as $row)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{!! url('' . $row->file . '') !!}" target="_blank"><i
                    ...
                    <table class="table table-bordered visit_table">
                        <thead>
                            <tr>
                                ...
                                <th>Bulan</th>
                                <th>Tahun</th>
                                <th>File Lap Bulanan</th>
                                <th>File Lap Akt Harian (ttd basah)</th>
                            </tr>
                        </thead>
                        <tbody>
                            @if (empty($bulanan))
                            ...
                            @else
                                ...
                                @foreach ($bulanan as $row)
                                    @if ($row->file_ttdbasah == '-' || empty($row->file_ttdbasah))
                                        <tr>
                                            <td>{{ $no++ }}</td>
                                            <td>{{ $row->month }}<br></td>
                                            <td>{{ $row->year }}<br></td>
                                    ...
                                    @else
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{!! url('' . $row->file_ttdbasah . '') !!}" target="_blank"><i
                                                        class="fa fa-file"></i></a>
                                            </td>
                                        </tr>
                                    @endif
