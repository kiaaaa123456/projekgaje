                        ...
                        <div class="align-self-center d-flex flex-wrap gap-2">
                            ...
                            <div class="align-self-center">
                                <div class="search-box d-flex">
                                    <input class="form-control act" id="search" placeholder="Cari Nama Pengguna" name="search" autocomplete="off" />
                ...
                <table class="table table-bordered" id="table-body">
                    <thead class="thead">
                        <tr>
                            ...
                            <th class="sorting_desc">Kontak</th>
                            ...
                            <th class="sorting_desc">Tgl Lahir</th>
                            <th class="sorting_desc">Jenis Kelamin</th>
                            <th class="sorting_desc tex-wrap">Alamat</th>
...
<script type="text/javascript">
    ...
    function loadData(page, limit, search, kodeprov, kodekab, kodekec, kodedesa){
        ...
        $.ajax({
        url: "daftar-fasilitator/"+page+'/'+limit+'/'+search+'/'+kodeprov+'/'+kodekab+'/'+kodekec+'/'+kodedesa,
        type: 'get',
        dataType: 'json',
                ...
                if (response['status']!='success') {
                    ...
                    if(len > 0){
                        ...
                        for(var i=0; i<len; i++){
                            ...
                            if(response['data'][i].aktif == 1) {
                                var status = '<button class="btn btn-success btn-sm">Aktif</button>';
                            } else {
                                var status = '<button class="btn btn-warning btn-sm">Tidak Aktif</button>';
                            }
                            if (response['data'][i].nmprov==null) {
                                var nmprov = '-';
                            } else {
                                var nmprov = response['data'][i].nmprov;
                            }
                            ...
                            "<td>" + response['data'][i].email+ "<br>"+response['data'][i].phone+"</td>" +
                            "<td>" + response['data'][i].title+ "</td>" +
                            "<td>" + nmprov+ "</td>" +
                            "<td>" + nmkab + "</td>" +
                            "<td>" + nmkec + "</td>" +
                            "<td>" + nmdesa + "</td>" +
                            "<td>" + response['data'][i].birth_date.split("-").reverse().join("-")+ "</td>" +
