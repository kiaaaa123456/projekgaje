...
@section('content')
    ...
    <div><h3>Daftar Role User</h3></div>
    <nav aria-label="breadcrumb ">
        <ol class="breadcrumb ot-breadcrumb ot-breadcrumb-basic">
            <li class="breadcrumb-item"><a href="{!!url('dashboard')!!}">Dashboard</a></li>
            <li class="breadcrumb-item active">Daftar Role User</li>
        </ol>
    </nav>
</div>
                ...
                <table class="table table-bordered" id="table-body">
                    <thead class="thead">
                        <tr>
                            ...
                            <th class="sorting_desc">Nama Role</th>
                            <th class="sorting_desc">Deskripsi</th>
                        </tr>
                    </thead>
...
<script type="text/javascript">
    ...
    function loadData(page, limit, search){
        ...
        $.ajax({
        url: "get-role/"+page+'/'+limit+'/'+search,
        type: 'get',
        dataType: 'json',
                ...
                if (response['status']!='success') {
                    ...
                    if(len > 0){
                        ...
                        for(var i=0; i<len; i++){
                            ...
                            "<td>" + response['data'][i].displayname + "</td>" +
                            "</tr>";
