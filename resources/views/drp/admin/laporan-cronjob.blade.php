                ...
                <table class="table table-bordered" id="table-body">
                    <thead class="thead">
                        <tr>
                            ...
                            <th class="sorting_desc">Jumlah Fasilitator (Belum Absen Pulang)</th>
...
<script type="text/javascript">
    ...
    function loadData(page, limit, date){
        ...
        $.ajax({
        url: "get-laporan-cronjob/"+page+"/"+limit+"/"+date,
        type: 'get',
        dataType: 'json',
                    ...
                    if(len > 0){
                        ...
                        for(var i=0; i<len; i++){
                            ...
                            if (response['data'][i].status=='success') {
                                var status = 'Berhasil';
                            } else if (response['data'][i].status=='empty') {
                                var status = 'Kosong';
                            } else {
                                var status = 'Gagal';
                            }
