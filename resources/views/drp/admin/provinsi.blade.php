                        ...
                        <div class="align-self-center d-flex flex-wrap gap-2">
                            ...
                            <div class="align-self-center">
                                <div class="search-box d-flex">
                                    <input class="form-control act" placeholder="Cari Provinsi" name="search" id="search" autocomplete="off" />
                ...
                <table class="table table-bordered" id="table-body">
                    <thead class="thead">
                        <tr>
                            ...
                            <th class="sorting_desc">Nama Provinsi</th>
                        </tr>
                    </thead>
...
<script type="text/javascript">
    ...
    function loadData(page, limit, search){
        ...
        $.ajax({
        url: "get-provinsi/"+page+'/'+limit+'/'+search,
        type: 'get',
        dataType: 'json',
