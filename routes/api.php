...
|
*/
Route::get('/downloadFormat/{id}', [VisitController::class, 'downloadFormat']);
        ...
        Route::group(['prefix' => 'user'], function () {
            ...
            Route::get('search/{keywords?}', [ProfileController::class, 'getUserList']);
                    ...
                    Route::group(['prefix' => 'attendance'], function () {
                        ...
                        Route::post('check-inout', [AttendanceController::class, 'checkInOut']);
                ...
                Route::prefix('visit')->group(function () {
                    ...
                    Route::get('/evkin', [VisitController::class, 'getEvkinList']);
