...
use App\Http\Controllers\Backend\Evkin\EvkinController;
...
Route::group(['prefix' => 'hrm', 'middleware' => ['xss', 'admin', 'MaintenanceMode']], function () {
    ...
    Route::group(['prefix' => 'appointment'], function () {
        ...
        Route::post('simpan-aktharian', [AppointmentController::class, 'store'])->name('appointment.store');
    ...
    Route::group(['prefix' => 'visit'], function () {
        ...
        Route::get('/add-data', [VisitController::class, 'create']);
        Route::post('/store', [VisitController::class, 'store'])->name('visit.store');
    });

    Route::group(['prefix' => 'evkin'], function () {
        Route::get('/', [EvkinController::class, 'index'])->name('evkin.index');
        Route::get('/fasilitator', [EvkinController::class, 'fasilitator'])->name('evkin.fasilitator');
        Route::get('/penilaian', [EvkinController::class, 'penilaian'])->name('evkin.penilaian');
        Route::get('/detail_evkin', [EvkinController::class, 'detail_evkin'])->name('evkin.detail_evkin');
    });
    //Visit end
    //expense start
